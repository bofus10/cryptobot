...
class Bittrex():
  ...
  def orders(self,method,symbol="",state):
    ...
    if method == "GET":
      ...
      query= {
              ...
              "quantity": "number (double)",  #quantity (optional, must be included for non-ceiling orders and excluded for ceiling orders)
              "ceiling": "number (double)",   #optional, must be included for ceiling orders and excluded for non-ceiling orders
              "limit": "number (double)",     #optional, must be included for LIMIT orders and excluded for MARKET orders)
